        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="d-flex flex-column flex-shrink-0 p-3 bg-light col-lg-5" style="width: 280px;">
                    ...
                    <li>
                        <a href="./progress.html" class="nav-link link-dark">
                ...
                <div class = "col-lg-7">
                    <div class="container mt-5">
                        <form action="./redirect.php" method="post">
                            ...
                            <input class = "btn btn-primary" type="submit" nama="kirim" value="kirim">
                            
                        </form>
                            <button class = "btn btn-primary mt-2" onclick="location.href='./guru.php'">
                                Batal!
                            </button>
                    </div>
                </div>
